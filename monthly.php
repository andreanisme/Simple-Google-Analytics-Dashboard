...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="monthly.php">Monthly</a>
                    </li>
                </ul>
    ...
    <div class="container main">
        ...
        <div class="row">
            <div class="col-md-12">  
                ...
                <div id="chart-pageviews-monthly-2012-container"></div>
            </div>
            <div class="col-md-12">
                <h3>Pageviews Januari 2013 - Desember 2013</h3>
                <small>Counts the total number of pageviews.</small>
                <div id="chart-pageviews-monthly-2013-container"></div>
            </div>
            <div class="col-md-12">
                <h3>Pageviews Januari 2014 - Now</h3>
                <small>Counts the total number of pageviews.</small>
                <div id="chart-pageviews-monthly-2014-container"></div>
            </div>
        </div>
    ...
    gapi.analytics.ready(function() {
         ...
         */
        var dataChartPageviewsMonthly2012 = new gapi.analytics.googleCharts.DataChart({
            query: {
            ...
            chart: {
                container: 'chart-pageviews-monthly-2012-container',
                type: 'COLUMN',
                options: {
                    width: '100%'
                }
         ...
         * It will be rendered inside an element with the id "chart-2-container".
         */
        var dataChartPageviewsMonthly2013 = new gapi.analytics.googleCharts.DataChart({
            query: {
                metrics: 'ga:pageviews',
                dimensions: 'ga:month',
            ...
            chart: {
                container: 'chart-pageviews-monthly-2013-container',
                type: 'COLUMN',
                options: {
                    width: '100%'
                }
        ...
        var dataChartPageviewsMonthly2014 = new gapi.analytics.googleCharts.DataChart({
            query: {
                metrics: 'ga:pageviews',
                dimensions: 'ga:month',
            ...
            chart: {
                container: 'chart-pageviews-monthly-2014-container',
                type: 'COLUMN',
                options: {
                    width: '100%'
                }
        ...
        viewSelector.on('change', function(ids) {
            ...
            dataChartPageviewsMonthly2012.set({
                query: {
                    ids: ids
                }
            }).execute();

            dataChartPageviewsMonthly2013.set({
                query: {
                    ids: ids
                }
            }).execute();

            dataChartPageviewsMonthly2014.set({
                query: {
                    ids: ids
                }
            }).execute();
